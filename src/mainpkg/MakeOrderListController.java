 ...
 * @author User
 */
public class MakeOrderListController implements Initializable {
    ...
    @FXML
    private void saveClickAction(ActionEvent event) {
         File f = null;
        ...
        try
        {
            ...
            Order o  = new Order(productnoTextField.getText(), addressTextField.getText(),timeTextField1.getText(),
        ...
        savetoList.setText("Saved Suceessful");
        productnoTextField.setText(null); 
        addressTextField.setText(null); 
        timeTextField1.setText(null); 
